...
AI 에이전트는 데이터 변경이나 조회 쿼리를 짤 때 다음 5개 핵심 테이블 구조를 준수해야 합니다. 자세한 명세는 [supabase_schema.md](file:///Users/kangheesung/.gemini/antigravity/brain/8307f805-1142-4f08-b08e-e20478d45834/supabase_schema.md)를 참고하십시오. 또한, UI/UX 구현 시 [design.md](file:///Users/kangheesung/10-19_개발/13_프로젝트/13.05_트레이딩/teamproject/design.md)에 기술된 스타일 규격을 완벽히 준수해야 합니다.
...
4. **디자인 시스템 엄격 준수**: UI를 개발할 때 [design.md](file:///Users/kangheesung/10-19_개발/13_프로젝트/13.05_트레이딩/teamproject/design.md)에 명시된 Obsidian Navy 배경, JetBrains Mono 폰트 사용처, Glassmorphism, 2px Cyan 매매 승인 카드 왼쪽 강조 테두리 등 모든 스타일 토큰을 정교하게 적용하십시오.
